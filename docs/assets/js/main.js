import { deleteAllTasksLS, getHigherIdTaskLS, getTodoTasksLS, getCompletedTasksLS, newTaskLS } from './storage.js';
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const extractData = () => {
    ...
    getCompletedTasksLS().forEach(task => {
      ...
      changeTask(completedTask.childNodes[1], completedTask.childNodes[0], false);
    });
  }
